...
public class DatanodeInfo extends DatanodeID implements Node {
  ...
  public DatanodeInfo(DatanodeInfo from) {
    ...
    this.readLoad = from.readLoad;
    this.writeLoad = from.writeLoad;
  }
  ...
  public DatanodeInfo(final String name, final String storageID,
    ...
    // TODO(bharath): Is it safe to do this? Is it better to pass in these values
    // from a constructor?
    this.readLoad = 0;
    this.writeLoad = 0;
  }
  ...
  public void setWriteLoad(double writeLoad) {
